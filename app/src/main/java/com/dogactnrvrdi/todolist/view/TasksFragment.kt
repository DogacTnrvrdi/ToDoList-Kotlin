...
import com.dogactnrvrdi.todolist.adapter.TasksAdapter
import com.dogactnrvrdi.todolist.databinding.FragmentTasksBinding
import com.dogactnrvrdi.todolist.util.onQueryTextChanged
import com.dogactnrvrdi.todolist.data.SortOrder
import com.dogactnrvrdi.todolist.data.Task
import com.dogactnrvrdi.todolist.util.exhaustive
import com.dogactnrvrdi.todolist.viewmodel.TasksViewModel
                    ...
                    when(event) {
                        is TasksViewModel.TasksEvent.ShowUndoDeleteTaskMessage -> {
                            Snackbar.make(requireView(),
                                context.getString(R.string.task_deleted), Snackbar.LENGTH_LONG)
